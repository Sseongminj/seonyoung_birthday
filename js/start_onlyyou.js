...
function init_onlyyou() {
  ...
  if (
    ...
    if (typeof start_bg_img != "undefined" && start_bg_img != "") {
      ...
      //});
      $("#div_onlyyou").prepend(
        '<img src="' + start_bg_img + '" style="width:100%; height:auto; display:block;">'
        );
    }
  }
...
function oy_show_benefit() {
  ...
  if (index_text_oy < count_text_oy) {
    ...
    if ($(document).height() - oy_text_height < 520) {
      ...
      $("#div_onlyyou").css({ "min-height": $(document).height() + 600 + "px" });
      $("#div_oy_inner").css({ "min-height": $(document).height() + 200 + "px" });
